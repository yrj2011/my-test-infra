...
var gubernatorPath = flag.String("gubernator-path", "http://gubernator.k8s.io", "Path to linked gubernator")
...
func TestURLTemplate(t *testing.T) {
	testcases := []struct {
		...
		},
		{
			...
			job:     "k8s-pre-1",
			build:   "1",
			expect:  "http://console.cloud.google.com/storage/browser/kubernetes-security-prow/pr-logs/pull/kubernetes-security_kubernetes/0/k8s-pre-1/1/",
			k8sOnly: true,
		},
		{

	...
	var testCases = []struct {
	...
	}{
		{
			...
			expectedBase: []cloneCommand{
				...
				{dir: "/go/src/github.com/org/repo", command: "git", args: []string{"fetch", "http://github.com/org/repo.git", "--tags", "--prune"}},
				{dir: "/go/src/github.com/org/repo", command: "git", args: []string{"fetch", "http://github.com/org/repo.git", "master"}},
		...
		},
		{
			...
			expectedBase: []cloneCommand{
				...
				{dir: "/go/src/my/favorite/dir", command: "git", args: []string{"fetch", "http://github.com/org/repo.git", "--tags", "--prune"}},
				{dir: "/go/src/my/favorite/dir", command: "git", args: []string{"fetch", "http://github.com/org/repo.git", "master"}},
		...
		},
		{
			...
			expectedPull: []cloneCommand{
				{dir: "/go/src/github.com/org/repo", command: "git", args: []string{"fetch", "http://github.com/org/repo.git", "pull/1/head"}},
		...
		},
		{
			...
			expectedPull: []cloneCommand{
				{dir: "/go/src/github.com/org/repo", command: "git", args: []string{"fetch", "http://github.com/org/repo.git", "pull-me"}},
				{dir: "/go/src/github.com/org/repo", command: "git", args: []string{"merge", "--no-ff", "FETCH_HEAD"}, env: gitTimestampEnvs(fakeTimestamp + 1)},
				{dir: "/go/src/github.com/org/repo", command: "git", args: []string{"submodule", "update", "--init", "--recursive"}},
			},
		},
		...
		},
		{
			...
			expectedPull: []cloneCommand{
				{dir: "/go/src/github.com/org/repo", command: "git", args: []string{"fetch", "http://github.com/org/repo.git", "pull/1/head"}},
				{dir: "/go/src/github.com/org/repo", command: "git", args: []string{"merge", "--no-ff", "FETCH_HEAD"}, env: gitTimestampEnvs(fakeTimestamp + 1)},
				{dir: "/go/src/github.com/org/repo", command: "git", args: []string{"fetch", "http://github.com/org/repo.git", "pull/2/head"}},

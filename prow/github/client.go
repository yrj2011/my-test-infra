...
// http://developer.github.com/v3/orgs/hooks/#list-hooks
...
// http://developer.github.com/v3/repos/hooks/#list-hooks
...
// http://developer.github.com/v3/orgs/hooks/#edit-a-hook
...
// http://developer.github.com/v3/orgs/hooks/#create-a-hook
...
func (c *Client) GetPullRequests(org, repo string) ([]PullRequest, error) {
	...
	err := c.readPaginatedResults(
		path,
		"application/vnd.github.symmetra-preview+json", // allow the description field -- http://developer.github.com/changes/2018-02-22-label-description-search-preview/
		func() interface{} {
			return &[]PullRequest{}
		},
		func(obj interface{}) {
...
func (c *Client) AddRepoLabel(org, repo, label, description, color string) error {
	...
	_, err := c.request(&request{
		...
		accept:      "application/vnd.github.symmetra-preview+json", // allow the description field -- http://developer.github.com/changes/2018-02-22-label-description-search-preview/
...
// }
//
// http://developer.github.com/v3/pulls/review_requests/#create-a-review-request
...
//
// See http://developer.github.com/v3/teams/#create-team
...
//
// See http://developer.github.com/v3/teams/#delete-team
...
//
// See http://developer.github.com/v3/teams/#list-teams

...
type CrossVersionObjectReference struct {
	// Kind of the referent; More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds"
...
type HorizontalPodAutoscaler struct {
	...
	// behaviour of autoscaler. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.
	// +optional

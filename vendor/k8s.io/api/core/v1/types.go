...
type VolumeSource struct {
	...
	// More info: http://kubernetes.io/docs/concepts/storage/volumes#hostpath
	// ---
	...
	// More info: http://kubernetes.io/docs/concepts/storage/volumes#emptydir
	// +optional
	EmptyDir *EmptyDirVolumeSource `json:"emptyDir,omitempty" protobuf:"bytes,2,opt,name=emptyDir"`
	// GCEPersistentDisk represents a GCE Disk resource that is attached to a
	// kubelet's host machine and then exposed to the pod.
	// More info: http://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk
	// +optional
	GCEPersistentDisk *GCEPersistentDiskVolumeSource `json:"gcePersistentDisk,omitempty" protobuf:"bytes,3,opt,name=gcePersistentDisk"`
	// AWSElasticBlockStore represents an AWS Disk resource that is attached to a
	// kubelet's host machine and then exposed to the pod.
	// More info: http://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore
	// +optional
	...
	// More info: http://kubernetes.io/docs/concepts/storage/volumes#secret
	// +optional
	Secret *SecretVolumeSource `json:"secret,omitempty" protobuf:"bytes,6,opt,name=secret"`
	// NFS represents an NFS mount on the host that shares a pod's lifetime
	// More info: http://kubernetes.io/docs/concepts/storage/volumes#nfs
	// +optional
	...
	// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
	// +optional
...
type PersistentVolumeSource struct {
	...
	// More info: http://releases.k8s.io/HEAD/examples/volumes/storageos/README.md
	// +optional
...
// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes
type PersistentVolume struct {
	...
	// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes#persistent-volumes
	// +optional
...
type PersistentVolumeSpec struct {
	...
	// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes#capacity
	// +optional
	Capacity ResourceList `json:"capacity,omitempty" protobuf:"bytes,1,rep,name=capacity,casttype=ResourceList,castkey=ResourceName"`
	// The actual volume backing the persistent volume.
	PersistentVolumeSource `json:",inline" protobuf:"bytes,2,opt,name=persistentVolumeSource"`
	// AccessModes contains all ways the volume can be mounted.
	// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes
	// +optional
	AccessModes []PersistentVolumeAccessMode `json:"accessModes,omitempty" protobuf:"bytes,3,rep,name=accessModes,casttype=PersistentVolumeAccessMode"`
	// ClaimRef is part of a bi-directional binding between PersistentVolume and PersistentVolumeClaim.
	// Expected to be non-nil when bound.
	// claim.VolumeName is the authoritative bind between PV and PVC.
	// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes#binding
	// +optional
	...
	// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes#reclaiming
	// +optional
	...
	// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes/#mount-options
	// +optional
...
type PersistentVolumeStatus struct {
	...
	// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes#phase
	// +optional
...
type PersistentVolumeClaimSpec struct {
	...
	// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes-1
	// +optional
	...
	// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes#resources
	// +optional
	...
	// More info: http://kubernetes.io/docs/concepts/storage/persistent-volumes#class-1
	// +optional
...
type RBDVolumeSource struct {
	...
	// More info: http://kubernetes.io/docs/concepts/storage/volumes#rbd
...
type ISCSIVolumeSource struct {
	...
	// Tip: Ensure that the filesystem type is supported by the host operating system.
	// Examples: "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.
	// More info: http://kubernetes.io/docs/concepts/storage/volumes#iscsi
	// TODO: how do we prevent errors in the filesystem from compromising the machine
	// +optional
...
const (
	...
	// URISchemeHTTPS means that the scheme used will be http://
...
type Probe struct {
	...
	// More info: http://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
	// +optional
...
type ResourceRequirements struct {
	...
	// More info: http://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/
	// +optional
...
type Container struct {
	...
	Name string `json:"name" protobuf:"bytes,1,opt,name=name"`
	// Docker image name.
	// More info: http://kubernetes.io/docs/concepts/containers/images
	...
	// Cannot be updated.
	// More info: http://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/#running-a-command-in-a-shell
	// +optional
	...
	// Cannot be updated.
	// More info: http://kubernetes.io/docs/concepts/containers/images#updating-images
	// +optional
	ImagePullPolicy PullPolicy `json:"imagePullPolicy,omitempty" protobuf:"bytes,14,opt,name=imagePullPolicy,casttype=PullPolicy"`
	// Security options the pod should run with.
	// More info: http://kubernetes.io/docs/concepts/policy/security-context/
	// More info: http://kubernetes.io/docs/tasks/configure-pod-container/security-context/
	// +optional
...
type Lifecycle struct {
	...
	// More info: http://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/#container-hooks
	// +optional
...
type PodCondition struct {
	...
	// More info: http://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-conditions
...
type PodSpec struct {
	...
	// More info: http://kubernetes.io/docs/concepts/storage/volumes
	// +optional
	// +patchMergeKey=name
	...
	// Cannot be updated.
	// More info: http://kubernetes.io/docs/concepts/workloads/pods/init-containers/
	// +patchMergeKey=name
	// +patchStrategy=merge
	...
	// Default to Always.
	// More info: http://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#restart-policy
	// +optional
	...
	// More info: http://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/
	// +optional
	...
	// More info: http://kubernetes.io/docs/concepts/containers/images#specifying-imagepullsecrets-on-a-pod
	// +optional
	// +patchMergeKey=name
	// +patchStrategy=merge
	...
	// More info: http://github.com/kubernetes/community/blob/master/keps/sig-network/0007-pod-ready%2B%2B.md
	// +optional
	...
	// More info: http://github.com/kubernetes/community/blob/master/keps/sig-node/0014-runtime-class.md
	// This is an alpha feature and may change in the future.
	// +optional
...
type PodStatus struct {
	...
	// startTime set.
	// More info: http://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status
	...
	// More info: http://git.k8s.io/community/contributors/design-proposals/node/resource-qos.md
	// +optional
...
type PodList struct {
	...
	// List of pods.
	// More info: http://git.k8s.io/community/contributors/devel/api-conventions.md
...
type PodTemplate struct {
	...
	// http://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
	// +optional
...
type ServiceSpec struct {
	...
	// More info: http://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies
	// +patchMergeKey=port
	// +patchStrategy=merge
	...
	// More info: http://kubernetes.io/docs/concepts/services-networking/service/
	// +optional
	Selector map[string]string `json:"selector,omitempty" protobuf:"bytes,2,rep,name=selector"`
	...
	// to the clusterIP.
	// More info: http://kubernetes.io/docs/concepts/services-networking/service/#publishing-services---service-types
	// +optional
	...
	// More info: http://kubernetes.io/docs/tasks/access-application-cluster/configure-cloud-provider-firewall/
	// +optional
	LoadBalancerSourceRanges []string `json:"loadBalancerSourceRanges,omitempty" protobuf:"bytes,9,opt,name=loadBalancerSourceRanges"`

	// externalName is the external reference that kubedns or equivalent will
	// return as a CNAME record for this service. No proxying will be involved.
	// Must be a valid RFC-1123 hostname (http://tools.ietf.org/html/rfc1123)
...
type ServicePort struct {
	...
	// More info: http://kubernetes.io/docs/concepts/services-networking/service/#defining-a-service
	// +optional
	...
	// More info: http://kubernetes.io/docs/concepts/services-networking/service/#type-nodeport
	// +optional
...
type ServiceAccount struct {
	...
	// More info: http://kubernetes.io/docs/concepts/configuration/secret
	// +optional
	// +patchMergeKey=name
	// +patchStrategy=merge
...
type NodeSpec struct {
	...
	// More info: http://kubernetes.io/docs/concepts/nodes/node/#manual-node-administration
	// +optional
...
type NodeSystemInfo struct {
	...
	// http://access.redhat.com/documentation/en-US/Red_Hat_Subscription_Management/1/html/RHSM/getting-system-uuid.html
...
type NodeStatus struct {
	...
	// More info: http://kubernetes.io/docs/concepts/nodes/node/#phase
	// The field is never populated, and now is deprecated.
	// +optional
	Phase NodePhase `json:"phase,omitempty" protobuf:"bytes,3,opt,name=phase,casttype=NodePhase"`
	// Conditions is an array of current observed node conditions.
	// More info: http://kubernetes.io/docs/concepts/nodes/node/#condition
	// +optional
	// +patchMergeKey=type
	// +patchStrategy=merge
	...
	// More info: http://kubernetes.io/docs/concepts/nodes/node/#addresses
	// +optional
	// +patchMergeKey=type
	// +patchStrategy=merge
	...
	// More info: http://kubernetes.io/docs/concepts/nodes/node/#info
	// +optional
...
type NamespaceSpec struct {
	...
	// More info: http://kubernetes.io/docs/tasks/administer-cluster/namespaces/
	// +optional
...
type ObjectReference struct {
	...
	// More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#concurrency-control-and-consistency
	// +optional
...
type ResourceQuotaSpec struct {
	...
	// More info: http://kubernetes.io/docs/concepts/policy/resource-quotas/
	// +optional
...
type Secret struct {
	...
	// data value here. Described in http://tools.ietf.org/html/rfc4648#section-4
	// +optional

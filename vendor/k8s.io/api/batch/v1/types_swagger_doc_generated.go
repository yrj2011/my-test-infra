...
var map_Job = map[string]string{
	...
	"spec":     "Specification of the desired behavior of a job. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status",
	"status":   "Current status of a job. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status",
}
...
var map_JobSpec = map[string]string{
	...
	"selector":                "A label query over pods that should match the pod count. Normally, the system sets this field for you. More info: http://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors",
	"manualSelector":          "manualSelector controls generation of pod labels and pod selectors. Leave `manualSelector` unset unless you are certain what you are doing. When false or unset, the system pick labels unique to this job and appends those labels to the pod template.  When true, the user is responsible for picking unique labels and specifying the selector.  Failure to pick a unique label may cause this and other jobs to not function correctly.  However, You may see `manualSelector=true` in jobs that were created with the old `extensions/v1beta1` API. More info: http://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/#specifying-your-own-pod-selector",
	"template":                "Describes the pod that will be created when executing a job. More info: http://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/",
...
var map_JobStatus = map[string]string{
	...
	"conditions":     "The latest available observations of an object's current state. More info: http://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/",

...
type JobSpec struct {
	...
	// More info: http://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/
	// +optional
	...
	// TODO enabled it when http://github.com/kubernetes/kubernetes/issues/28486 has been fixed
	...
	// API.
	// More info: http://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/#specifying-your-own-pod-selector
	// +optional

...
var map_CronJob = map[string]string{
	...
	"spec":     "Specification of the desired behavior of a cron job, including the schedule. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status",
	"status":   "Current status of a cron job. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status",
}
...
var map_CronJobSpec = map[string]string{
	...
	"schedule":                   "The schedule in Cron format, see http://en.wikipedia.org/wiki/Cron.",
...
var map_JobTemplate = map[string]string{
	...
	"metadata": "Standard object's metadata. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#metadata",
	"template": "Defines jobs that will be created from this template. http://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status",
}
...
var map_JobTemplateSpec = map[string]string{
	...
	"metadata": "Standard object's metadata of the jobs created from this template. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#metadata",
	"spec":     "Specification of the desired behavior of the job. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status",
}

...
var map_Status = map[string]string{
	...
	"metadata": "Standard list metadata. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
	"status":   "Status of the operation. One of: \"Success\" or \"Failure\". More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status",
...
var map_StatusDetails = map[string]string{
	...
	"kind":              "The kind attribute of the resource associated with the status StatusReason. On some operations may differ from the requested resource Kind. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
...
var map_TypeMeta = map[string]string{
	...
	"kind":       "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
	"apiVersion": "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: http://git.k8s.io/community/contributors/devel/api-conventions.md#resources",
}

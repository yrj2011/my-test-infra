...
func register(client autorest.Client, originalReq *http.Request, re RequestError) error {
	...
	// http://github.com/Azure/azure-sdk-for-go/blob/9f366792afa3e0ddaecdc860e793ba9d75e76c27/arm/resources/resources/providers.go#L252
	...
	for err == nil && time.Since(now) < client.PollingDuration {
		// taken from the resources SDK
		// http://github.com/Azure/azure-sdk-for-go/blob/9f366792afa3e0ddaecdc860e793ba9d75e76c27/arm/resources/resources/providers.go#L45
		preparer := autorest.CreatePreparer(
			autorest.AsGet(),
			autorest.WithBaseURL(newURL.String()),

...
//
// GitHub API docs: http://developer.github.com/v3/repos/releases/#get-the-latest-release
...
//
// GitHub API docs: http://developer.github.com/v3/repos/releases/#get-a-release-by-tag-name

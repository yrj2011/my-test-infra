...
//
// GitHub API docs: http://developer.github.com/v3/issues/assignees/#add-assignees-to-an-issue
...
//
// GitHub API docs: http://developer.github.com/v3/issues/assignees/#remove-assignees-from-an-issue

...
//
// GitHub API docs: http://developer.github.com/v3/repos/statistics/#contributors
...
// delay of a second or so, should result in a successful request.
//
// GitHub API docs: http://developer.github.com/v3/repos/statistics/#commit-activity
...
// delay of a second or so, should result in a successful request.
//
// GitHub API docs: http://developer.github.com/v3/repos/statistics/#code-frequency
...
// delay of a second or so, should result in a successful request.
//
// GitHub API docs: http://developer.github.com/v3/repos/statistics/#participation
...
// delay of a second or so, should result in a successful request.
//
// GitHub API docs: http://developer.github.com/v3/repos/statistics/#punch-card
